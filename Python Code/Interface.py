...
def newGameWindow (): # gameState: config
    ...
    frame_layout = [[sg.Radio('Pc Cam', group_id='grp', default = True, key = "pccam"), sg.VerticalSeparator(pad=None), sg.Radio('USB2', group_id='grp', key = "usb2")]]
